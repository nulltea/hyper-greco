...
def main(args): 
    ...
    output_path = os.path.join("bfv-gkr", "src", "data", filename)

    with open(output_path, 'w') as f:
        json.dump(json_input, f)

    output_path = os.path.join("bfv-gkr", "src", "constants", f"sk_enc_constants_{args.n}_{qis_len}x{qis_bitsize}_{args.t}.rs")
